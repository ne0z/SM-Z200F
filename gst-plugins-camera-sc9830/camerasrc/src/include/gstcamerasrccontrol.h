...
{ \
	Type *this = (Type *)control; \
	gint dummy = 0; \
	return gst_camerasrc_control_set_value(this, control_channel, dummy); \
} \
 \
static gboolean \
...
{ \
	Type *this = (Type *)control; \
	gint dummy = 0; \
	return gst_camerasrc_control_get_value(this, control_channel, &dummy); \
} \
 \
static gboolean \
...
{ \
    Type* this = (Type*)control; \
    return gst_camerasrc_control_set_ae_lock( this, value); \
} \
\
 static gboolean \
...
{ \
    Type* this = (Type*)control; \
    return gst_camerasrc_control_get_ae_lock( this, value); \
} \
\
 static gboolean \
...
{ \
    Type* this = (Type*)control; \
    return gst_camerasrc_control_set_awb_lock( this, value); \
} \
\
 static gboolean \
...
{ \
    Type* this = (Type*)control; \
    return gst_camerasrc_control_get_awb_lock( this, value); \
} \
 \
static void \
...
{ \
 ...
 \
    ...
    klass->get_ae_lock    = interface_as_function ## _control_get_ae_lock; \
    klass->set_awb_lock    = interface_as_function ## _control_set_awb_lock; \
    klass->get_awb_lock    = interface_as_function ## _control_get_awb_lock; \
