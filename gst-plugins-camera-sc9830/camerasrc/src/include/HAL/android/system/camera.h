...
enum {
    ...
    CAMERA_MSG_ZOOM_STEP_NOTIFY = 0x1000,
    CAMERA_MSG_AUTO_PARAMETERS_NOTIFY = 0x2000, //auto parameter notify
    CAMERA_MSG_SHOT_END       = 0x4000, //shot end noti
...
#ifdef __PLATFORM_TIZEN__
    CAMERA_CMD_RAW_BURST_TAKE = 1575,
    CAMERA_CMD_RAW_TAKE = 1590,
#endif
...
#ifdef __PLATFORM_TIZEN__
    CAMERA_CMD_SET_CAMERA_ACCESS_MODE = 1643,
    CAMERA_CMD_NOFOCUS_PREFLASH = 1644,
    CAMERA_CMD_PANORAMA_MODE = 1645
#endif
};

#ifdef __PLATFORM_TIZEN__
enum {
    CAMERA_SHOT_MODE_NORMAL = 0,
    CAMERA_SHOT_MODE_LLS = 1,
    CAMERA_SHOT_MODE_HDR = 2
};
...
typedef struct camera_frame_metadata {
    ...
    /**
     * The value for low light condition
     */
    int32_t needLLS;
#ifdef __PLATFORM_TIZEN__ ///TODO: Fix me Check new file
    int light_condition;
#endif
