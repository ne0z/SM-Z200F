...
on_key_down(void *data, Evas *e, Evas_Object *obj, void *event_info)
{
    ...
    if (!strcmp(ev->key, "XF86Back") || !strcmp(ev->key, "F1")) {
...
static void on_console_message(void *data, Evas_Object *obj, void *event_info)
{
...
//    ewk_settings_enable_frame_flattening_set(settings, frame_flattening_enabled);
    ...
    evas_object_smart_callback_add(app_data->webview, "console,message", on_console_message, app_data);
    ...
    evas_object_resize(app_data->window, width, height);
