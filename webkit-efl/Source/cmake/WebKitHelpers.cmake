...
# Dear upversioners, please don't merge below three lines.
    IF (NOT SHARED_CORE AND NOT ENABLE_TIZEN_WEBKIT2_EFL_WTR)
        SET(OLD_COMPILE_FLAGS "-fvisibility=hidden ${OLD_COMPILE_FLAGS}")
        IF (TIZEN_FEATURE_WEBKIT_LITE)
            SET(OLD_COMPILE_FLAGS "${OLD_COMPILE_FLAGS} -fvisibility-inlines-hidden")
        ENDIF ()
    ENDIF ()
# endif
    ...
    #SET(OLD_COMPILE_FLAGS "-W -Wall -Wextra -Wcast-align -Wchar-subscripts -Wformat -Wformat-security -Wmissing-format-attribute -Wno-format-y2k -Wno-parentheses -Wno-unused-parameter -Wpointer-arith  -Wreturn-type -Wundef -Wwrite-strings ${OLD_COMPILE_FLAGS}")
    SET(OLD_COMPILE_FLAGS "-W -Wall -Wextra -Wchar-subscripts -Wformat -Wformat-security -Wmissing-format-attribute -Wno-format-y2k -Wno-parentheses -Wno-unused-parameter -Wpointer-arith  -Wreturn-type -Wundef -Wwrite-strings ${OLD_COMPILE_FLAGS}")
