...
IF ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU" AND ${LOWERCASE_CMAKE_HOST_SYSTEM_PROCESSOR} MATCHES "(i[3-6]86|x86)" AND ("${CMAKE_BUILD_TYPE}" STREQUAL "Debug" OR "$ENV{CXXFLAGS}" MATCHES "-g"))
