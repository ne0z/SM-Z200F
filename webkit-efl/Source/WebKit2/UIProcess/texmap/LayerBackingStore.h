...
public:
#if ENABLE(TIZEN_WEBKIT2_TILED_AC_SHARED_PLATFORM_SURFACE)
    virtual ~LayerBackingStore() { }
#endif
    TIZEN_VIRTUAL void createTile(int, float);
    TIZEN_VIRTUAL void createTile(int, float, bool);
    TIZEN_VIRTUAL void removeTile(int);
    ...
    TIZEN_VIRTUAL void commitTileOperations(WebCore::TextureMapper*);
    TIZEN_VIRTUAL PassRefPtr<WebCore::BitmapTexture> texture() const;
