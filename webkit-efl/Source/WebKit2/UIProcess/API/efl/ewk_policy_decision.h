...
enum _Ewk_Policy_Callback_Type {
    EWK_POLICY_CALLBACK_TYPE_NAVIGATION = 0,
    EWK_POLICY_CALLBACK_TYPE_NEW_WINDOW = 1,
    EWK_POLICY_CALLBACK_TYPE_RESPONSE = 2,
};
typedef enum _Ewk_Policy_Callback_Type Ewk_Policy_Callback_Type;
 ...
 */
EXPORT_API const char* ewk_policy_decision_http_method_get(Ewk_Policy_Decision* policyDecision);
// #endif
 ...
 */
EXPORT_API int ewk_policy_decision_response_status_code_get(Ewk_Policy_Decision* policyDecision);
/*#endif*/
...
/**
 * Returns http body from Policy Decision object.
 *
 * @param policy_decision policy decsision object
 *
