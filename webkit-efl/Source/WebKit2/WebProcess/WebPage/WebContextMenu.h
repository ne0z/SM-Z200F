...
private:
    ...
    void initContextMenuItemSequence(Vector<int>& contextMenuItemSequence);
    bool sortProposedMenu(Vector<WebContextMenuItemData>& proposedMenu, Vector<WebContextMenuItemData>& sortedProposedMenu);
#endif
