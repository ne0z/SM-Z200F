...
template<typename C, typename MF, typename P1, typename P2, typename P3, typename R>
void callMemberFunction(const Arguments3<P1, P2, P3>& args, PassRefPtr<R> delayedReply, C* object, MF function)
{
...
void callMemberFunction(const Arguments7<P1, P2, P3, P4, P5, P6, P7>& args, ArgumentDecoder* argumentDecoder, Arguments3<R1, R2, R3>& replyArgs, C* object, MF function)
{
    (object->*function)(args.argument1, args.argument2, args.argument3, args.argument4, args.argument5, args.argument6, args.argument7, argumentDecoder, replyArgs.argument1, replyArgs.argument2, replyArgs.argument3);
}
