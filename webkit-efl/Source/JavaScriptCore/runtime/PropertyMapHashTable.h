...
inline PropertyTable::~PropertyTable()
{
    ...
    // FIXME: It's just for scrutinizing information about memory corruption.
    // We're assuming that uninitialized pointer has been used again in somewhere.
    // This initialization brings us to the very spot right after accessing invalid memory area.
    m_index = NULL;
}
