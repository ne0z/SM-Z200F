...
#define TIZEN_PROFILE \
    WTF::TizenProfiler profileObject(__PRETTY_FUNCTION__, __LINE__);

#define TIZEN_LOG \
    WTF::TizenProfiler loggerObject(__PRETTY_FUNCTION__, __LINE__);

#define LOG_SUPPORT 1
#define DEPTH_SUPPORT 1
#define PROFILE_ONLY_IN_SPECIFIED_FUNCTIONS 0
#define PROFILE_EXCLUDE_NESTED_CALLS 1
