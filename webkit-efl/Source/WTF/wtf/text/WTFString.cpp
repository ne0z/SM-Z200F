...
String::String(const char *characters, unsigned length, ConstructFromLiteralTag)
    : m_impl(characters ? StringImpl::createFromLiteral(reinterpret_cast<const LChar*>(characters), length) : 0)
{
}
#endif
