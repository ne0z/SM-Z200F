...
public:
    ...
    bool isLocatedInViewport() { return m_isLocatedInViewport; }
    CachedResource* prevInAllResourcesList() { return m_prevInAllResourcesList; }
#endif
...
#if ENABLE(TIZEN_BACKGROUND_DISK_CACHE)
    HashCountedSet<CachedResourceClient*> clients(void) { return m_clients; }
    void setLocatedInViewport(bool isInViewport) { m_isLocatedInViewport = isInViewport; }

    bool m_isLocatedInViewport;
#endif
