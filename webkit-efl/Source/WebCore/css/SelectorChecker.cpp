...
bool SelectorChecker::checkSelector(const CSSSelector* sel, Element* element, bool isFastCheckableSelector) const
{
...
#if ENABLE(TIZEN_CSS_SELECTOR_READ_ONLY_READ_WRITE)
            if (!element)
                return false;
...
bool SelectorChecker::checkScrollbarPseudoClass(const CSSSelector* sel, PseudoId&) const
{
