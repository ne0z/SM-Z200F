...
#if ENABLE(TIZEN_GSTREAMER_VIDEO)
    void addKeyframeRule(StyleRuleKeyframes*);
    const Vector<StyleRuleKeyframes*>& keyframeRules() const { return m_keyframeRules; }
#endif
...
#if ENABLE(TIZEN_GSTREAMER_VIDEO)
    Vector<StyleRuleKeyframes*> m_keyframeRules;
#endif
};
