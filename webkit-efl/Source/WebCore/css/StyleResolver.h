...
public:
    ...
    void addKeyframeStyle(const Vector<StyleRuleKeyframes*>&);
#endif
...
#if PLATFORM(TIZEN)
    bool currentMatchResultHasAuthorStylesForProperty(RenderStyle*, CSSPropertyID) const;
#endif
...
#if PLATFORM(TIZEN)
    MatchResult* m_currentMatchResult;
#endif
};
