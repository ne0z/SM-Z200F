...
void MediaStreamRecorder::record(MediaStreamDescriptor* descriptor, const String& prefix)
{
    m_recorder->record(descriptor, prefix);
}
...
void MediaStreamRecorder::onRecorded(PassOwnPtr<Vector<char> > data)
{
    if (!m_callback)
        return;
...
#endif // ENABLE(TIZEN_MEDIA_STREAM_RECORDER)
