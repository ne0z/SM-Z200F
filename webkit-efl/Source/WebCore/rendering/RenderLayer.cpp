                        ...
                        PaintLayerFlags paintFlags)
{
    ...
    if (paintsWithTransform(paintBehavior) && !(paintFlags & PaintLayerAppliedTransform)) {
        ...
        // Apply the transform.
        {
            ...
            paintLayerContentsAndReflection(this, context, enclosingIntRect(transform.inverse().mapRect(paintDirtyRect)), paintBehavior, paintingRoot, region, overlapTestRequests, paintFlags);
        }        
