...
RenderTableCell::RenderTableCell(Element* element)
    ...
    , m_hasAssociatedTableCellElement(element && (element->hasTagName(tdTag) || element->hasTagName(thTag)))
...
{
    return table()->collapseBorders() ? LayoutUnit::fromPixel(borderHalfLeft(false)) : RenderBlock::borderLeft();
}

LayoutUnit RenderTableCell::borderRight() const
{
    return table()->collapseBorders() ? LayoutUnit::fromPixel(borderHalfRight(false)) : RenderBlock::borderRight();
}

LayoutUnit RenderTableCell::borderTop() const
{
    return table()->collapseBorders() ? LayoutUnit::fromPixel(borderHalfTop(false)) : RenderBlock::borderTop();
}

LayoutUnit RenderTableCell::borderBottom() const
{
    return table()->collapseBorders() ? LayoutUnit::fromPixel(borderHalfBottom(false)) : RenderBlock::borderBottom();
}
...
{
    return table()->collapseBorders() ? LayoutUnit::fromPixel(borderHalfStart(false)) : RenderBlock::borderStart();
}

LayoutUnit RenderTableCell::borderEnd() const
{
    return table()->collapseBorders() ? LayoutUnit::fromPixel(borderHalfEnd(false)) : RenderBlock::borderEnd();
}

LayoutUnit RenderTableCell::borderBefore() const
{
    return table()->collapseBorders() ? LayoutUnit::fromPixel(borderHalfBefore(false)) : RenderBlock::borderBefore();
}

LayoutUnit RenderTableCell::borderAfter() const
{
    return table()->collapseBorders() ? LayoutUnit::fromPixel(borderHalfAfter(false)) : RenderBlock::borderAfter();
}
