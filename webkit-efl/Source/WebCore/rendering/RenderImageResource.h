...
public:
    ...
    virtual PassRefPtr<Image> image(int /* width */ = 0, int /* height */ = 0, bool autoLoadImages = true) const { return m_cachedImage ? m_cachedImage->imageForRenderer(m_renderer, autoLoadImages) : nullImage(); }
#else
