...
FloatSize StyleCachedImage::imageSize(const RenderObject* renderer, float multiplier) const
{
...
void StyleCachedImage::setContainerSizeForRenderer(const RenderObject* renderer, const FloatSize& imageContainerSize, float imageContainerZoomFactor)
{
...
PassRefPtr<Image> StyleCachedImage::image(RenderObject* renderer, const FloatSize&) const
{
