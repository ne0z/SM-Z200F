...
FloatSize StyleGeneratedImage::imageSize(const RenderObject* renderer, float multiplier) const
{
    if (m_fixedSize) {
...
PassRefPtr<Image> StyleGeneratedImage::image(RenderObject* renderer, const FloatSize& size) const
{
