...
public:
    ...
    virtual FloatSize imageSize(const RenderObject*, float multiplier) const;
    ...
    virtual void setContainerSizeForRenderer(const RenderObject*, const FloatSize& containerSize, float) { m_containerSize = containerSize; }
    virtual void addClient(RenderObject*);
    virtual void removeClient(RenderObject*);
    virtual PassRefPtr<Image> image(RenderObject*, const FloatSize&) const;
