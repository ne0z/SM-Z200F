...
public:
    ...
    virtual FloatSize imageSize(const RenderObject*, float multiplier) const = 0;
    ...
    virtual void setContainerSizeForRenderer(const RenderObject*, const FloatSize&, float) = 0;
    virtual void addClient(RenderObject*) = 0;
    virtual void removeClient(RenderObject*) = 0;
    virtual PassRefPtr<Image> image(RenderObject*, const FloatSize&) const = 0;
