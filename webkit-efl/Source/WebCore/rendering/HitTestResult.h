...
public:
    ...
    Image* childNodeImage() const;
    String altChildDisplayString() const;
    KURL findChildAbsoluteImageURL();
    KURL childImageNonSharedImageURL() const;
    Node* innerChildImageNonSharedNode() const { return m_innerChildImageNonSharedNode.get(); }
#endif
...
#if ENABLE(TIZEN_CHILD_NODE_IMAGE_URL)
    RefPtr<Node> m_innerChildImageNonSharedNode;
#endif
};
