...
namespace WebCore {
    ...
    // ======== All public functions below this point are candidates to move out of Frame into another class. ========
        ...
        int getUCFrameID() const { return m_ucFrameID; }
        void setUCFrameID(int frameId) { m_ucFrameID = frameId; }
        bool ucBypassGet() { return m_ucByPass; }
        void ucBypassSet(bool enable) { m_ucByPass = enable; }
#endif

#if ENABLE(TIZEN_WEBKIT2_HISTORICAL_RESTORE_VISIBLE_CONTENT_RECT) || ENABLE(TIZEN_FILTER_SCALE_BUG_FIX)
        float contentsScaleFactor() const;
#endif
    ...
    private:
        ...
        virtual bool recordingSurfaceSetIsReplayingGet() { return false; }
#endif
#endif
