...
namespace WebCore {
    ...
    public:
        ...
        virtual float contentsScaleFactor() const;
#endif
        ...
        void addSearchProvider(const String&, const String&);
        unsigned long isSearchProviderInstalled(const String&, const String&);
#endif
