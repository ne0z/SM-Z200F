...
void Chrome::requestVisibleContentRectRestore(const IntPoint& scrollOffset, float scale)
{
    m_client->requestVisibleContentRectRestore(scrollOffset, scale);
}

float Chrome::contentsScaleFactor() const
{
    return m_client->contentsScaleFactor();
}
#endif
...
void Chrome::addSearchProvider(const String& baseURL, const String& engineURL)
{
    return m_client->addSearchProvider(baseURL, engineURL);
}

unsigned long Chrome::isSearchProviderInstalled(const String& baseURL, const String& engineURL)
{
    return m_client->isSearchProviderInstalled(baseURL, engineURL);
}
#endif
