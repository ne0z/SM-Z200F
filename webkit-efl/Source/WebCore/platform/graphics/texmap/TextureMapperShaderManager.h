...
class TextureMapperShaderProgramSimpleUV : public TextureMapperShaderProgram {
public:
    static PassRefPtr<TextureMapperShaderProgramSimpleUV> create()
    {
        return adoptRef(new TextureMapperShaderProgramSimpleUV());
    }

private:
    TextureMapperShaderProgramSimpleUV();
};

class TextureMapperShaderProgramOpacityAndMaskUV : public TextureMapperShaderProgram {
public:
    static PassRefPtr<TextureMapperShaderProgramOpacityAndMaskUV> create()
    {
        return adoptRef(new TextureMapperShaderProgramOpacityAndMaskUV());
    }

private:
    TextureMapperShaderProgramOpacityAndMaskUV();
};
#endif
