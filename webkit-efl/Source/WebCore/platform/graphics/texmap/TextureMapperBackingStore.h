...
public:
    ...
    virtual bool isHavingTiles() { return true;}
#endif
protected:
...
public:
    ...
    void updateContents(TextureMapper* textureMapper, Image* image) { updateContents(textureMapper, image, image->size(), enclosingIntRect(image->rect())); }
