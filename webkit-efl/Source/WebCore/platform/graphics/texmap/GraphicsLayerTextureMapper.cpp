...
void GraphicsLayerTextureMapper::setSkipCompositing(bool value)
{
    if (value == skipCompositing())
        return;
    notifyChange(TextureMapperLayer::SkipCompositing);
    GraphicsLayer::setSkipCompositing(value);
}
#endif
