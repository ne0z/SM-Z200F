...
void* ImageFrame::lockTbmBuffer()
{
    ...
    // If context is not bound, we should bind context before lockTbmBuffer.
    // Otherwise, lockup is occurred when eglDestroyImageKHR function is called.
    if (!eglGetCurrentContext())
        m_platformSurface->makeContextCurrent();
