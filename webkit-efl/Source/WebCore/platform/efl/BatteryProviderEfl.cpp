...
#if ENABLE(TIZEN_BATTERY_STATUS)
void batteryChargingAndLevelChangeCallback(keynode_t *keynode, void* data)
{
...
void batteryTimeToFullyChargedChangeCallback(keynode_t *keynode, void* user_data)
{
    BatteryProviderEfl* client = static_cast<BatteryProviderEfl*>(user_data);
    BatteryStatus* clientBatteryStatus = client->batteryStatus();
    int chargingTime = std::numeric_limits<int>::infinity();
...
void batteryTimeToDischargedChangeCallback(keynode_t *keynode, void* user_data)
{
    BatteryProviderEfl* client = static_cast<BatteryProviderEfl*>(user_data);
    BatteryStatus* clientBatteryStatus = client->batteryStatus();
    int dischargingTime = std::numeric_limits<int>::infinity();
