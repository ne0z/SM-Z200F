...
bool SpeechRecognitionProviderTizen::startProvider()
{
    ...
    return !isError(m_sttProvider->sttStart(m_lang.utf8().data(), STT_RECOGNITION_TYPE_FREE));
}
...
// Callbacks
void SpeechRecognitionProviderTizen::sttResultCallback(stt_h stt, stt_result_event_e event, const char** data, int dataCount, const char* msg, void* userData)
{
