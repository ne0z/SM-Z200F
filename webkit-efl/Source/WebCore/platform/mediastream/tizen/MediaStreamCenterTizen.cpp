...
void MediaStreamCenterTizen::didAddMediaStreamTrack(MediaStreamDescriptor*, MediaStreamComponent*)
{
}

void MediaStreamCenterTizen::didRemoveMediaStreamTrack(MediaStreamDescriptor*, MediaStreamComponent*)
{
}
...
String MediaStreamCenterTizen::constructSDP(IceCandidateDescriptor*)
{
    return String();
}

String MediaStreamCenterTizen::constructSDP(SessionDescriptionDescriptor*)
{
    return String();
}
