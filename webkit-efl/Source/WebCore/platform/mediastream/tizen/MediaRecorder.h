...
public:
    ...
    virtual void onRecorded(PassOwnPtr<Vector<char> > data) { }
...
public:
    ...
    void record(MediaStreamDescriptor*, const String& prefix);
    void save();
    void cancel();

    void onRecorded(PassOwnPtr<Vector<char> > data);
    void onRecorded(const String& path);

private:
    MediaRecorder(MediaRecorderClient*);
