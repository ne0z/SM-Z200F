...
static gboolean webkitAccessibleComponentGrabHighlight(AtkComponent* component)
{
    ...
    AccessibilityObject* accessibilityObject = core(component);

    if(accessibilityObject && accessibilityObject->page() && accessibilityObject->page()->chrome()->client())
    {
        accessibilityObject->page()->chrome()->client()->highlightNode(accessibilityObject->elementRect());
        return true;
    }
    return false;
}
...
static gboolean webkitAccessibleComponentClearHighlight(AtkComponent* component)
{
    ...
    if(accessibilityObject && accessibilityObject->page() && accessibilityObject->page()->chrome()->client())
    {
        accessibilityObject->page()->chrome()->client()->clearHighlightedNode();
        return true;
    }
    return false;
}
