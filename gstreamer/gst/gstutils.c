    ...
    const gchar * stream_id)
{
  ...
  if (!upstream_stream_id) {
    GstQuery *query;
//[prasenjit.c][P160609-06014] Causing crash during Hotstar Playback due to NULL uri.
//Open Source Merge (https://cgit.freedesktop.org/gstreamer/gstreamer/commit/gst/gstutils.c?id=ee9ca5d48b9c0f0e8b5714a0d08b8915e85e8572)
    gchar *uri = NULL;
