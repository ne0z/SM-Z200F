...
#ifdef GST_TAGLIST_MODIFICATION
  gst_tag_register_static (GST_TAG_V360_SPHERICAL, GST_TAG_FLAG_META,
      G_TYPE_STRING,
      _("v360-spherical"), _("v360 spherical metadata"), NULL);
  gst_tag_register_static (GST_TAG_V360_STITCHED, GST_TAG_FLAG_META,
      G_TYPE_STRING,
      _("v360-stitched"), _("v360 stitched metadata"), NULL);
  gst_tag_register_static (GST_TAG_V360_STITCHING_SOFTWARE, GST_TAG_FLAG_META,
      G_TYPE_STRING,
      _("v360-stitching-software"), _("v360 stitching software metadata"), NULL);
  gst_tag_register_static (GST_TAG_V360_PROJECTION_TYPE, GST_TAG_FLAG_META,
      G_TYPE_STRING,
      _("v360-projection-type"), _("v360 projection type metadata"), NULL);
#endif
}
