...
pause:
  {
...
#ifdef GST_ADD_LOG
    GST_WARNING_OBJECT (src, "task paused");
#endif /* GST_ADD_LOG */
    ...
    if (ret == GST_FLOW_EOS) {
...
#ifdef GST_ADD_LOG
      GST_WARNING_OBJECT (src, "GST_FLOW_EOS case");
#endif /* GST_ADD_LOG */
      ...
      if (src->priv->forced_eos) {
...
#ifdef GST_ADD_LOG
        GST_WARNING_OBJECT (src, "forced_eos case");
#endif /* GST_ADD_LOG */
        GST_OBJECT_LOCK (src);
        ...
        GstMessage *message;
#ifdef GST_ADD_LOG
        GST_WARNING_OBJECT (src, "flag_segment case");
#endif /* GST_ADD_LOG */
...
#ifdef GST_ADD_LOG
        GST_WARNING_OBJECT (src, "gst_pad_push_event for eos");
#endif /* GST_ADD_LOG */
