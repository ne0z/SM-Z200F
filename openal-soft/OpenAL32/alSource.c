...
AL_API ALvoid AL_APIENTRY alGenSources(ALsizei n,ALuint *sources)
{
    ...
    AL_PRINT("gen %d source(s) of context:%p (current active:%d)", n, Context, Context->ActiveSourceCount);
...
AL_API ALvoid AL_APIENTRY alDeleteSources(ALsizei n, const ALuint *sources)
{
    ...
    AL_PRINT("delete %d source(s) of context:%p (current active:%d)", n, Context, Context->ActiveSourceCount);
...
AL_API ALvoid AL_APIENTRY alSourcePlayv(ALsizei n, const ALuint *sources)
{
    ...
    AL_PRINT("play %d source(s) of context:%p (current active:%d)", n, Context, Context->ActiveSourceCount);
...
AL_API ALvoid AL_APIENTRY alSourcePausev(ALsizei n, const ALuint *sources)
{
    ...
    AL_PRINT("pause %d source(s) of context:%p (current active:%d)", n, Context, Context->ActiveSourceCount);
...
AL_API ALvoid AL_APIENTRY alSourceStopv(ALsizei n, const ALuint *sources)
{
    ...
    AL_PRINT("stop %d source(s) of context:%p (current active:%d)", n, Context, Context->ActiveSourceCount);
...
AL_API ALvoid AL_APIENTRY alSourceRewindv(ALsizei n, const ALuint *sources)
{
    ...
    AL_PRINT("rewind %d source(s) of context:%p (current active:%d)", n, Context, Context->ActiveSourceCount);
