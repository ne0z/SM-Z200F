...
void al_print(unsigned int level, const char *fname, unsigned int line, const char *func, const char *fmt, ...)
             PRINTF_STYLE(5,6);
#define AL_PRINT(...) al_print(4/*DLOG_INFO*/, __FILE__, __LINE__, __func__, __VA_ARGS__)
#define AL_DEBUG(...) al_print(3/*DLOG_DEBUG*/, __FILE__, __LINE__, __func__, __VA_ARGS__)
#else
void al_print(const char *fname, unsigned int line, const char *fmt, ...)
             PRINTF_STYLE(3,4);
#define AL_PRINT(...) al_print(__FILE__, __LINE__, __VA_ARGS__)
#define AL_DEBUG(...) al_print(__FILE__, __LINE__, __VA_ARGS__)
#endif
