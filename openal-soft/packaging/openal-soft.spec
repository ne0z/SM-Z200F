...
%ifarch %arm
export CFLAGS+=" -DARM_ARCH -O3 -ftree-vectorize -ffast-math -fsingle-precision-constant -DUSE_ASM_IN_PULSEAUDIO -DSUPPORT_CORK_BY_STATE -DUSE_DLOG "
%else
export CFLAGS+=" -DI386_ARCH -DUSE_ASM_IN_PULSEAUDIO -DSUPPORT_CORK_BY_STATE "
%endif
