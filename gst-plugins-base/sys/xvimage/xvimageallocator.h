...
GstXvContext *gst_xvimage_allocator_peek_context (GstXvImageAllocator *
    allocator);

GstMemory *gst_xvimage_allocator_alloc (GstXvImageAllocator * allocator,
    gint im_format,
    gint padded_width,
    gint padded_height, GstVideoRectangle * crop, GError ** error);
...
void gst_xvimage_memory_set_buffer (GstXvImageMemory * mem,
    GstBuffer * new_buf);
