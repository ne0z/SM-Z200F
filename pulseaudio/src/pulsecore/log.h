...
#ifdef __TIZEN_LOG__
#define pa_secure_log_debug(...)  pa_log_level_secure(PA_LOG_DEBUG,  __FILE__, __LINE__, __func__, __VA_ARGS__)
#define pa_secure_log_info(...)   pa_log_level_secure(PA_LOG_INFO,   __FILE__, __LINE__, __func__, __VA_ARGS__)
#define pa_secure_log_notice(...) pa_log_level_secure(PA_LOG_NOTICE, __FILE__, __LINE__, __func__, __VA_ARGS__)
#define pa_secure_log_warn(...)   pa_log_level_secure(PA_LOG_WARN,   __FILE__, __LINE__, __func__, __VA_ARGS__)
#define pa_secure_log_error(...)  pa_log_level_secure(PA_LOG_ERROR,  __FILE__, __LINE__, __func__, __VA_ARGS__)
#endif
