...
static const pa_echo_canceller ec_table[] = {
    ...
    {
        /* LVVEFS */
        .init                   = pa_lvvefs_ec_init,
        .run                    = pa_lvvefs_ec_run,
        .done                   = pa_lvvefs_ec_done,
        .set_volume             = pa_lvvefs_ec_set_volume,
        .set_device             = pa_lvvefs_ec_set_device,
    },
#endif
};
...
#endif
#if defined(ENABLE_LVVEFS)
    else if (strcmp(method, "lvvefs") == 0)
        return PA_ECHO_CANCELLER_LVVEFS;
#endif
...
#if defined(ENABLE_LVVEFS)
    u->ec->set_volume = ec_table[ec_method].set_volume;
    u->ec->set_device = ec_table[ec_method].set_device;
#endif
