...
#ifdef ASFDEMUX_MODIFICATION
      if (video_format_object.tag == GST_MAKE_FOURCC ('W', 'M', 'V', '1')
              || video_format_object.tag == GST_MAKE_FOURCC ('W', 'M', 'V', '2')
              || video_format_object.tag == GST_MAKE_FOURCC ('W', 'M', 'V', '3')
              || video_format_object.tag == GST_MAKE_FOURCC ('W', 'M', 'V', 'A'))
      {
    ...
    guint64 * p_size)
{
  ...
  else if (obj.id == ASF_OBJ_PLAYREADY_ENCRYPTION_OBJECT || obj.id == ASF_OBJ_UNKNOWN_ENCRYPTION_OBJECT)
  {
