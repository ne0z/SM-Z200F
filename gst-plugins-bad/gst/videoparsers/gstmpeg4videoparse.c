...
gst_mpeg4vparse_update_src_caps (GstMpeg4VParse * mp4vparse)
{
  ...
  /* perhaps we have a framerate */
  {
    ...
    // [prasenjit.c] During Live HTTP / RTSP mpeg4 links , since fixed_vop_time_increment value is 0 , so framerate field does not get set
...
#ifdef GST_MPEG4VIDEOPARSE_MODIFICATION
  gst_caps_set_simple (caps,"data_partitioned", G_TYPE_BOOLEAN, mp4vparse->vol.data_partitioned, NULL);
#endif
