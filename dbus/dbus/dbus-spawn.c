  ...
  if (pid < 0)
      ...
      if (grandchild_pid < 0)
	{
	  ...
	  if (fd_err >= 0)
          ...
          {
            /* If dbus is running as systemd service, dbus process
               default oom_score_adj is -900 and oom_adj is -15. So
               the children will also have same value. To avoid this,
               set the child itself values after fork () to 0. */
            FILE *file;
