...
_elm_layout_theme_set(Eo *obj, Elm_Layout_Smart_Data *sd, const char *klass, const char *group, const char *style)
{
   ...
   UPF_TRACE_BEGIN_F(UPF_TRACE_TAG_ELEMENTARY, "_elm_layout_theme_set: obj(%p), type(%s), klass(%s), group(%s), style(%s)", obj, elm_widget_type_get(obj), klass, group, style);
...
elm_layout_file_set(Eo *obj, const char *file, const char *group)
{
   ...
   UPF_TRACE_BEGIN_F(UPF_TRACE_TAG_ELEMENTARY, "elm_layout_file_set: (%p) file(%s) (%s)", obj, file, group);
   ...
   ret = eo_do_ret((Eo *) obj, ret, efl_file_set(file, group));
