...
//TIZEN_ONLY(20151019) - nl_langinfo(D_T_FMT) returns formats over 64 bytes for some locales(km_KH)
#define ELM_DATETIME_MAX_FORMAT_LEN       128
//
...
struct _Elm_Datetime_Module_Data
{
   ...
   void         (*field_set)(Evas_Object *obj,
                             Elm_Datetime_Field_Type field_type,
