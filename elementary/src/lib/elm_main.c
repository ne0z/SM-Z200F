...
elm_exit(void)
{
   ERR("elm_exit is called normally.");

   UPF_TRACE_BEGIN_F(UPF_TRACE_TAG_ELEMENTARY, "elm_exit");
                     ...
                     const char  *style)
{
   ...
   UPF_TRACE_BEGIN_F(UPF_TRACE_TAG_ELEMENTARY, "elm_object_style_set: (%p) (%s)", obj, style);
