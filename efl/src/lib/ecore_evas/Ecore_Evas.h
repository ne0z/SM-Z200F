...
EAPI Ecore_Evas     *ecore_evas_software_x11_pixmap_allocfunc_new(const char *disp_name, Ecore_X_Window parent, int x, int y, int w, int h, unsigned int (*alloc_func) (void *data, unsigned int parent, int w, int h, int depth), void (*free_func) (void *data, unsigned int pixmap), void *data);
...
EAPI Ecore_Evas     *ecore_evas_gl_x11_pixmap_allocfunc_new(const char *disp_name, Ecore_X_Window parent, int x, int y, int w, int h, unsigned int (*alloc_func) (void *data, unsigned int parent, int w, int h, int depth), void (*free_func) (void *data, unsigned int pixmap), void *data);
