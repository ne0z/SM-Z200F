...
EAPI extern Ecore_X_Atom ECORE_X_ATOM_E_COMP_BUSY_NOTIFY;
EAPI extern Ecore_X_Atom ECORE_X_ATOM_E_COMP_EVAS_WIN;
EAPI extern Ecore_X_Atom ECORE_X_ATOM_E_APPPROFILE_FEATURE_ENABLE_DISABLE;
EAPI extern Ecore_X_Atom ECORE_X_ATOM_E_APPPROFILE_GPU_WIN;
