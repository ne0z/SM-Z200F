...
EAPI Ecore_X_Atom ECORE_X_ATOM_E_COMP_BUSY_NOTIFY = 0;
EAPI Ecore_X_Atom ECORE_X_ATOM_E_COMP_EVAS_WIN = 0;
EAPI Ecore_X_Atom ECORE_X_ATOM_E_APPPROFILE_FEATURE_ENABLE_DISABLE = 0;
EAPI Ecore_X_Atom ECORE_X_ATOM_E_APPPROFILE_GPU_WIN = 0;
...
const Atom_Item atom_items[] =
{
   ...
   { "_E_COMP_BUSY_APP_NOTIFY", &ECORE_X_ATOM_E_COMP_BUSY_NOTIFY },
   { "_E_COMP_BUSY_APP_NOTIFY_EVAS_WIN", &ECORE_X_ATOM_E_COMP_EVAS_WIN },
   { "_E_APPPROFILE_FEATURE_ENABLE_DISABLE", &ECORE_X_ATOM_E_APPPROFILE_FEATURE_ENABLE_DISABLE },
   { "_E_APPPROFILE_WIN_IS_GPU", &ECORE_X_ATOM_E_APPPROFILE_GPU_WIN },
   ...
   // TIZEN_ONLY(20150730): Add missing Tizen Only ECORE_X_ATOM_*.
   /* for SDB(Samsung Debug Bridge) */
