...
typedef void (*_Evas_Object_Del_Cb)(Evas_Object* root, Evas_Object *obj);
_Evas_Object_Del_Cb _evas_object_del_cb = NULL;

EAPI void
_evas_object_del_cb_set(_Evas_Object_Del_Cb cb)
{
   _evas_object_del_cb = cb;
}
...
evas_object_del(Evas_Object *eo_obj)
{
   ...
   UPF_TRACE_BEGIN_F(UPF_TRACE_TAG_EVAS, "%p", eo_obj);
