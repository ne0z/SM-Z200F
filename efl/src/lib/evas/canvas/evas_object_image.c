...
evas_object_image_add(Evas *eo_e)
{
   ...
   UPF_TRACE_BEGIN_F(UPF_TRACE_TAG_EVAS, "%p", eo_e);
...
evas_object_image_preload(Evas_Object *eo_obj, Eina_Bool cancel)
{
   ...
   UPF_TRACE_BEGIN_F(UPF_TRACE_TAG_EVAS, "(%p) cancel(%d)", eo_obj, cancel);
            ...
            Eina_Bool do_async)
{
   ...
   UPF_TRACE_BEGIN_F(UPF_TRACE_TAG_EVAS, "%d", do_async);
