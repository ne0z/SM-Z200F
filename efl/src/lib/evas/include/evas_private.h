...
/*    void (*image_rotation_set)              (void *data, void *image); */
   ...
   Eina_Bool (*gl_surface_direct_renderable_get) (void *data, Evas_Native_Surface *ns, Eina_Bool *direct_override, void *surface);
...
typedef void (*_Evas_Input_Debug_Cb)(void *_evas_input_debug_info);

typedef struct /** Mouse button debug event */
{
   int type;
   Evas_Event_Mouse_Down *mouse_down;
   Evas_Event_Mouse_Up *mouse_up;
   Evas_Event_Multi_Down *multi_down;
   Evas_Event_Multi_Up *multi_up;
   Evas_Event_Key_Down *key_down;
   Evas_Event_Key_Up *key_up;
   Evas_Object *smart_parent;
   Evas_Object *object;
}_Evas_Input_Debug_Info;

// samsung product only
typedef void (*_Evas_Event_Object_List_cb)(Evas_Callback_Type type, Eina_List *obj_list, Eina_Bool proxy);
