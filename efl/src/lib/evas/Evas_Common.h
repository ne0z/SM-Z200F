...
typedef enum _Evas_Text_Style_Type
{
   ...
   EVAS_TEXT_STYLE_TIZEN_GLOW_SHADOW,      /** Samsung::Graphics::Effect::EFFECT_FOR_TEXT_ON_HOME_SCREEN_ICON */
   EVAS_TEXT_STYLE_TIZEN_SOFT_GLOW_SHADOW,      /** Samsung::Graphics::Effect::EFFECT_FOR_TEXT_ON_DYNAMIC_BOX_IMPORT_IMAGE */
   EVAS_TEXT_STYLE_TIZEN_SHADOW,      /** Samsung::Graphics::Effect::EFFECT_FOR_TEXT_ON_DYNAMIC_BOX_IMAGE */
   //////////////////////////////
