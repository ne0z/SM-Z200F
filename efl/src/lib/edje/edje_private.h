...
#ifdef EFL_FEATURE_CHANGEABLE_UI
   Eina_List            *styles; /* support edje's styles */
#endif
...
}_Edje_Touch_Core_Info;

typedef Eina_Bool (*_Edje_Touch_Enhancement_Cb)(_Edje_Touch_Core_Info *edje_touch_down_info, _Edje_Touch_Core_Info *edje_touch_up_info);
...
void              _edje_recalc_color(Edje *ed);
#endif
...
#endif
//
EAPI Eina_List * edje_object_color_class_list(Evas_Object *obj);
EAPI void edje_object_text_class_del(Evas_Object *obj, const char *text_class);
EAPI Evas_Object* _edje_object_part_swallow_get2(Evas_Object *obj, const char *part, Eina_Bool recalc);
EAPI const Evas_Object* _edje_object_part_object_get2(Evas_Object *obj, const char *part);
EAPI void _edje_object_part_unswallow2(Evas_Object *obj, Evas_Object *obj_swallow, Eina_Bool recalc);
EAPI Eina_Bool _edje_object_part_swallow2(Evas_Object *obj, const char *part, Evas_Object *obj_swallow, Eina_Bool recalc);
EAPI Eina_List * edje_object_text_class_list(Evas_Object *obj);

EAPI void _edje_touch_enhancement_cb_set(_Edje_Touch_Enhancement_Cb cb);
EAPI void _edje_mouse_click_area_threshold_set(Evas_Coord click_area_threshold);
EAPI Evas_Coord _edje_mouse_click_area_threshold_get(void);
