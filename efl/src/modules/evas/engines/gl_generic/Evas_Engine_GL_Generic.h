...
typedef int (*Window_Age_Get)(Outbuf *ob);
typedef void *(*Window_Display_Get)(Outbuf *ob);
typedef int (*Window_Native_Config_Check)(void *disp, void *cfg, int target, void *pixmap, int *w, int *h);
...
struct _Render_Engine_GL_Generic
{
   ...
   Window_Age_Get window_age_get;
   Window_Display_Get window_display_get;
   Window_Native_Config_Check window_native_config_check;
                                   ...
                                   int w, int h)
{
   ...
   re->window_age_get = window_age_get;
   re->window_display_get = window_display_get;
   re->window_native_config_check = window_native_config_check;
