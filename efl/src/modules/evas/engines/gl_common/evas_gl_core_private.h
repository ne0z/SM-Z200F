...
struct _EVGL_Interface
{
   ...
   // Set prerotation for native window
...
extern void           _evgl_api_get(Evas_GL_API *api, Eina_Bool debug, Eina_Bool get_ext);
extern void           _evgl_api_gles1_get(Evas_GL_API *api, Eina_Bool debug, Eina_Bool get_ext);
extern Eina_Bool      _evgl_api_gles3_get(Evas_GL_API *api, Eina_Bool debug, Eina_Bool get_ext);
