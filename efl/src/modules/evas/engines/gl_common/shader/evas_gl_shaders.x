...
/* Source: modules/evas/engines/gl_common/shader/tex_external_mask_frag.shd */
static const char const tex_external_mask_frag_glsl[] =
   ...
   "void main()\n"
   "{\n"
   "   gl_FragColor = texture2D(tex, tex_c.xy) * texture2D(texm, tex_m.xy).a * col;\n"
   "}\n";
...
/* Source: modules/evas/engines/gl_common/shader/tex_external_mask_vert.shd */
...
/* Source: modules/evas/engines/gl_common/shader/tex_external_mask_nomul_frag.shd */
static const char const tex_external_mask_nomul_frag_glsl[] =
   ...
   "void main()\n"
   "{\n"
   "   gl_FragColor = texture2D(tex, tex_c.xy) * texture2D(texm, tex_m.xy).a;\n"
   "}\n";
...
/* Source: modules/evas/engines/gl_common/shader/tex_external_mask_nomul_vert.shd */
...
static const struct {
   ...
   { SHADER_TEX_EXTERNAL_MASK, &(shader_tex_external_mask_vert_src), &(shader_tex_external_mask_frag_src), "tex_external_mask" },
   { SHADER_TEX_EXTERNAL_MASK_NOMUL, &(shader_tex_external_mask_nomul_vert_src), &(shader_tex_external_mask_nomul_frag_src), "tex_external_mask_nomul" },
};
