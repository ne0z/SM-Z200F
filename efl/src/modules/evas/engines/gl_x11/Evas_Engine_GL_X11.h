...
typedef enum _Evas_Engine_Info_GL_X11_Drawable_Type
{
   EVAS_ENGINE_GL_X11_DRAWABLE_TYPE_WINDOW = 0,
   EVAS_ENGINE_GL_X11_DRAWABLE_TYPE_PIXMAP = 1
} Evas_Engine_Info_GL_X11_Drawable_Type;
...
struct _Evas_Engine_Info_GL_X11
{
   ...
   unsigned char drawable_type : 1; // whether drawable is window or pixmap
