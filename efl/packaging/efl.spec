...
%endif
export LDFLAGS+=" -fvisibility=hidden -Wl,--hash-style=both -Wl,--as-needed -Wl,-z,noexecstack"

# changeable UI flag
export CFLAGS+=" -DEFL_FEATURE_CHANGEABLE_UI"
...
#export CFLAGS="$CFLAGS -DEFL_OVERHEAD_LOG"
#export CXXFLAGS="$CXXFLAGS -DEFL_OVERHEAD_LOG"
#export FFLAGS="$FFLAGS -DEFL_OVERHEAD_LOG"
#%endif
...
mkdir -p %{buildroot}/etc/opt/upgrade && cp -af %{_builddir}/%{buildsubdir}/packaging/220.evas.patch.sh %{buildroot}/etc/opt/upgrade/

mkdir -p %{buildroot}%{_datadir}/license
#cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/evil
#cp %{_builddir}/%{buildsubdir}/licenses/COPYING.GPL %{buildroot}/%{_datadir}/license/escape
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.LGPL %{buildroot}/%{_datadir}/license/eina
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/eet
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/eo
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.FTL %{buildroot}/%{_datadir}/license/ector
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/evas
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.SMALL %{buildroot}/%{_datadir}/license/embryo
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/ecore
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.LGPL %{buildroot}/%{_datadir}/license/eio
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.LGPL %{buildroot}/%{_datadir}/license/eldbus
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/efreet
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/eeze
#cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/ephysics
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/edje
#cp %{_builddir}/%{buildsubdir}/licenses/COPYING.GPL %{buildroot}/%{_datadir}/license/epp
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/emotion
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.LGPL %{buildroot}/%{_datadir}/license/ethumb
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/eolian
cp %{_builddir}/%{buildsubdir}/licenses/COPYING.BSD %{buildroot}/%{_datadir}/license/elua
...
#%post -n evas
#/sbin/ldconfig
#chmod 700 /etc/opt/upgrade/220.evas.patch.sh
...
#/etc/opt/upgrade/220.evas.patch.sh
